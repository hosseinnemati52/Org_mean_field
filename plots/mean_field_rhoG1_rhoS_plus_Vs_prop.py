...
def sol_population_plotter(par, sol):
    ...
    plt.ylabel(r'$\langle N(t)/N(0) \rangle$', fontsize=20)
    # plt.grid()
...
def cost_calc(F_0, s, c_w, c_c, plot_switch):
    ...
    plt.xlabel('initial WT percentage', fontsize=18)
    plt.ylabel('WT Normalized Number at t=60h', fontsize=18)
    ...
    plt.xlabel('initial C percentage', fontsize=18)
    plt.ylabel('C Normalized Number at t=60h', fontsize=18)
    plt.xticks(fontsize=18)
    plt.yticks(fontsize=18)
    plt.legend()
    plt.tight_layout()
...
def dim_temporal_plot_func(time, n_w_p, n_c_p, n_w_mix_mat, n_c_mix_mat):
    ...
    plt.ylabel(r'$\overline{N(t)/N(0)}$', fontsize=18)
    # plt.grid()
    plt.xticks( fontsize=18)
    plt.yticks(fontsize=18)
    plt.yscale("log")
...
def compos_effect_plotter(sol, par):
    ...
    plt.xlabel('initial WT fraction', fontsize=20)
    plt.xticks(fontsize=20)
    # plt.ylabel('WT Normalized Number at t=60h', fontsize=12)
    plt.ylabel('WT(t=60h)/WT(0)', fontsize=20)
    plt.yticks(fontsize=20)
    ...
    plt.xlabel('initial C fraction', fontsize=20)
    plt.xticks(fontsize=20)
    # plt.ylabel('C Normalized Number at t=60h', fontsize=12)
    plt.ylabel('C(t=60h)/C(0)', fontsize=20)
    plt.yticks(fontsize=20)
    plt.legend(fontsize=20)
    plt.tight_layout()
    plt.savefig('mean_field_C_compos.PNG', dpi=300)
