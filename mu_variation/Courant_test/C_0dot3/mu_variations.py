...
def rho_solver(par, sol, rho_G1_0_0_w, rho_G1_0_0_c, n_0_d, M_0):
    ...
    for dt_c in range(1,L):
        ...
        # n_w_d[dt_c]  =  n_w_d[dt_c-1] + dt * par.R_0_d  * n_w_g1[dt_c-1]
        ...
        n_w_d[dt_c]  =  n_w_d[dt_c-1] + dt * par.R_0_d  * 0.5 * (n_w_g1[dt_c-1] + n_w_g1[dt_c])
...
def sol_obj_maker(sol_dum, par_dum):
    ...
    ## mesh
    sol_dum.n_interval_G1 = 200
    sol_dum.n_interval_S  = 200
...
def total_ploter_pureC(par_list, pop_sol_list):
    ...
    for i in range(len(par_list)):
        ...
        if np.abs(np.exp(value) - 3.9188) <0.1:
            plt.plot(pop_sol_list[i].time, pop_sol_list[i].pure_c, label=label, color = color)
        else:
            plt.plot(pop_sol_list[i].time, pop_sol_list[i].pure_c, label=label, color = color, linestyle='dotted')
...
MU_C_list = mu_w_orig * np.array([3.9188])
